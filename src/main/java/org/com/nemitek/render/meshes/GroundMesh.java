 ...
 */
public class GroundMesh implements MeshInterface {
    ...
    public GroundMesh()
    {
        ...
        this.textureName = "concrete2_seamless";
    ...
    public void init() {
        ...
        v0.setXYZ(-50f, -0.5f, -50f); v0.setRGB(1, 0, 0); v0.setST(0, 0);
        VertexData v1 = new VertexData();
        v1.setXYZ(50f, -0.5f, -50f); v1.setRGB(0, 1, 0); v1.setST(100, 0);
        VertexData v2 = new VertexData();
        v2.setXYZ(-50f, -0.5f, 50f); v2.setRGB(0, 0, 1); v2.setST(0, 100);
        VertexData v3 = new VertexData();
        v3.setXYZ(50f, -0.5f, 50f); v3.setRGB(1, 1, 1); v3.setST(100, 100);
